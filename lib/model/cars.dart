...
[Car(0,
  ...
  Car(1,
      'Лада Гранта',
      '1.6 MT Drive Active Comfort 23',
      '1 232 900 рублей',
      ['1.6 л',
        '106 л.с.',
        '6,5 л',
  ...
  Car(2,
      ...
      ['1.7 л',
        ...
        '220 мм',
        '320 л',],
      'Завод «Лада Запад Тольятти» (бывшее СП GM-AvtoVAZ) с 21 декабря приступил к производству глубоко модернизированной версии Lada Niva (бывший Chevrolet Niva). С рестайлингом машина получила новое имя — Lada Niva Travel. Экстерьер Нивы освежили за счет полностью нового оформления передней части кузова и других элементов сзади. По стилю обновленная Niva одновременно напоминает несостоявшийся проект Chevrolet Niva II и японскую Toyota RAV4 последнего поколения.',
      "https://youtu.be/kuEOwvTmu74?si=jw500fkKXx0OS52A",
  ...
  Car(4,
      ...
      ['1.5 л',
        ...
        '170 мм',
        '520 л',],
      'Московский автомобильный завод «Москвич» (бывший завод Renault) в 2022 году начинает серийную крупноузловую сборку двух новых моделей — бензинового кроссовера «Москвич 3» и электрического «Москвич 3е». Обе машины являются переименованными версиями китайских JAC: это модели Sehol X4 и E40X соответственно. Обычный «Москвич 3» выпускается в модификациях с бензиновыми турбомоторами объемом 1,5 л (HFC4GB24D) мощностью 150 л.с. Внешне и внутри автомобиль практически не отличается от китайского оригинала, кроме эмблем. ',
      "https://youtu.be/8zR3wF8UE6Y?si=-W22x4VHxBK4afXM",
  ...
  Car(6,
      ...
      "https://youtu.be/JXsvvZb4eAM?si=F2u1mn6BdP1TtvzH",
  ...
  Car(7,
      'УАЗ Пикап',
      '2.7 MT Base ИКАР Limited Евро-5',
      '1 860 000 рублей',
      ['2,7 л',
        '150 л.с.',
        '12,8 л',
        ...
        '210 мм',
        '1400 л',],
      'В 2008 году вместе с очередной волной модернизации автомобиля УАЗ Патриот производитель предложил модель в новом кузове со сдвоенной 4-дверной 5-местной кабиной и небольшим открытым кузовом. Патриот Пикап — это серьезный автомобиль, способный работать в различных условиях и на дорогах с любым покрытием. Патриот Пикап имеет удлиненную до 3000 мм базу и обладает грузоподъемностью 725 кг. Размеры грузовой платформы 1400 х 1500 х 650 позволяют с легкостью перевозить габаритные предметы, без боязни запачкать или поцарапать салон. Мощные двигатели — бензиновый и дизельный — в сочетании с механической коробкой передач обеспечивают хорошую динамику. Рамная конструкция, крепкая подвеска, большой дорожный просвет, привод 4х4 создают ощущение надежности и полной свободы передвижения.',
      "https://youtu.be/sspkaaLtGIk?si=qX5ov-IR51sqHrdV",
